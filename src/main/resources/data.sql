...
INSERT INTO tb_movie (title, sub_title, year, img_url, sinopsis, genre_id) VALUES ('A Última Esperança', 'Sobrevivência', 2019, 'Link da Imagem', 'Em um mundo pós-apocalíptico, um grupo de sobreviventes luta para encontrar um refúgio seguro.', 3);
