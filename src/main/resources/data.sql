...
INSERT INTO tb_movie (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Aventura Espacial', 'Em Busca do Futuro', 2022, 'Link da Imagem', 'Em um futuro distante, uma equipe de astronautas parte em uma jornada épica em busca de respostas.', 2);
INSERT INTO tb_movie (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('O Segredo do Vale', 'Mistério Profundo', 2020, 'Link da Imagem', 'Um detetive investiga estranhos acontecimentos em uma cidade isolada nas montanhas.', 1);
INSERT INTO tb_movie (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('Amor Eterno', 'O Destino nos Olhos', 2021, 'Link da Imagem', 'Um romance arrebatador que transcende o tempo, explorando o poder do amor verdadeiro.', 2);
